...
do 
    ...
    source /afs/cern.ch/work/a/atishelm/private/HH_WWgg/MC_Producer_Setup.sh ${saved_array_0[$i]} ${saved_array_1[$i]} ${saved_array_2[$i]} ${saved_array_3[$i]} ${saved_array_4[$i]}
