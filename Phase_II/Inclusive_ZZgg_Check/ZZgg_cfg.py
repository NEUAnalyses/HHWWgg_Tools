...
# with command line options: Configuration/GenProduction/python/ZZgg-fragment.py --python_filename ZZgg_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:ZZgg.root --conditions 110X_mcRun4_realistic_v3 --beamspot HLLHC14TeV --step LHE,GEN --geometry Extended2026D49 --era Phase2C9 --no_exec --mc -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ZZgg-fragment.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZZgg.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZZgg_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:daughters = 22, 22, 23, 23'
        ),
