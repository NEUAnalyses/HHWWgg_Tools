...
config.General.requestName = 'X3000_GluGluToRadionToHHTo2G2WTo2G4Q'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False
 
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '/afs/cern.ch/work/a/atishelm/private/HHWWgg_Tools/Lightweight_MC_Production/Test/CMSSW_10_6_25/src/B2G-RunIISummer20UL17wmLHEGEN-01293_WWgg_M3000_cfg.py'
