...
config.General.requestName = 'X1000_GluGluToRadionToHHTo2G2WTo2G2Q1L1Nu'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False
 
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '/afs/cern.ch/work/a/atishelm/private/HHWWgg_Tools/Lightweight_MC_Production/Test/CMSSW_10_6_25/src/B2G-RunIISummer20UL17wmLHEGEN-01293_WWggqqlnu_M1000_cfg.py'
