...
# 20 December 2019
#
# The purpose of this module is to create madgraph/pythia config files 
...
# Different mass points corrsesponding to gridpack list entries in order 
