...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('NMSSM_XYoYH_MX_500_MY_300_no_param_card_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'), ##-- Locally produced gridpack  
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:daughters = 22, 22, 22, 22',
          ),
